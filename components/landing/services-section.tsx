    ...
    <section id="services" className="py-20 md:py-32 relative bg-background">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 tracking-tight text-foreground">Cutting-Edge Digital Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <Card className="bg-card/60 border border-border backdrop-blur-md p-8 h-full group transition-all duration-300 hover:border-primary/30 hover:bg-card/90 hover:shadow-lg">
                <div className="mb-6 p-4 rounded-xl bg-primary/10 inline-block border border-primary/20 shadow-inner group-hover:scale-105 transition-transform duration-300">
                  {service.icon}
                </div>
                <h3 className="text-xl font-semibold mb-3 text-card-foreground tracking-tight">{service.title}</h3>
